...
\begin{risk}{Test automatici non esaustivi}
  ...
  \riskmitigation{Al termine dello sviluppo, è previsto l'invio di un questionario \gls{sus} a un campione di utenti, al fine di raccogliere feedback che, pur essendo orientati all’usabilità, possono offrire un contributo aggiuntivo alla valutazione manuale del sistema}
