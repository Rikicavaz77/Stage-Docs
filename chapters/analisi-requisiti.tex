...
\begin{usecase}{2.1}{Visualizzazione del meta tag keywords}\label{UC2point1}
    ...
    \usecaseextEnv{\begin{itemize}
        \item Visualizzazione di un avviso se il meta tag keywords non è presente (\hyperref[UC19]{UC19}).
    \end{itemize}}
\end{usecase}
...
\begin{usecase}{2.4}{Visualizzazione della lingua della pagina}\label{UC2point4}
    ...
    \usecaseextEnv{\begin{itemize}
        \item Visualizzazione di un avviso se l'attributo lang non è presente (\hyperref[UC20]{UC20}).
    \end{itemize}}
\end{usecase}
...
\begin{usecase}{5}{Visualizzazione di una lista delle parole chiave}\label{UC5}
    ...
    \end{itemize}}
    \usecaseincEnv{\begin{itemize}
        \item Visualizzazione di una singola parola chiave all’interno della lista (\hyperref[UC6]{UC6}).
    \end{itemize}}
\end{usecase}
...
\begin{usecase}{6}{Visualizzazione di una singola parola chiave all’interno della lista}\label{UC6}
    ...
    \usecaseincEnv{\begin{itemize}
        \item Visualizzazione della parola chiave vera e propria (\hyperref[UC10]{UC10});
        \item Visualizzazione della frequenza di una parola chiave (\hyperref[UC11]{UC11}).
    \end{itemize}}
\end{usecase}
...
\begin{usecase}{11}{Visualizzazione della frequenza di una parola chiave}\label{UC11}
    ...
    \usecaseextEnv{\begin{itemize}
        \item Visualizzazione di un avviso se la frequenza di una parola chiave è 0 (\hyperref[UC19]{UC19}).
    \end{itemize}}
\end{usecase}
...
\begin{usecase}{12}{Visualizzazione della densità di una parola chiave}\label{UC12}
    ...
    \usecaseextEnv{\begin{itemize}
        \item Visualizzazione di un avviso se la densità di una parola chiave è 0\% (\hyperref[UC20]{UC20}).
    \end{itemize}}
\end{usecase}
...
\begin{usecase}{17}{Navigazione delle parole chiave}\label{UC17}
    ...
    \usecasepreEnv{\begin{itemize}
        ...
        \item Il sistema è attivo e funzionante.
    \end{itemize}}
    \usecasepost{L’utente naviga le parole chiave tramite un sistema di paginazione.}
\end{usecase}
...
\hline
RF.O.29 & L'utente deve poter navigare le parole chiave tramite un sistema di paginazione. & \hyperref[UC17]{UC17} \\
\hline
...
\hline
RF.O.35 & Il sistema deve evidenziare le parole chiave con colori diversi in base al tag HTML che le racchiude. & DP\textsuperscript{*} \\
\hline
RF.OP.36 & Il sistema deve identificare le keyphrase "spezzate" su più tag HTML. & DP\textsuperscript{*} \\
\end{tabularx}
...
\hline
Funzionale & 26 & 4 & 6 & 36 \\
\hline
Di qualità & 1 & 1 & 1 & 3 \\
\hline 
Di vincolo/dominio & 2 & 0 & 0 & 2 \\
\hline
\textbf{Totale} & 29 & 5 & 7 & \textbf{41} \\ 
\hline
\end{tabular}
\end{table}
...
\hline
16 & Come utente, voglio analizzare anche le parole chiave “spezzate” su più tag HTML, in modo da gestire correttamente le keyphrase. \\
\hline
17 & Come utente, voglio che la funzionalità di analisi \gls{seo} sia accessibile a tutti. \\
\end{tabularx}