...
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc1} illustra graficamente il caso d’uso UC1.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_1.jpg}
        \caption{UC1}
        \label{fig:uc1}
    \end{figure}
\end{minipage}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc2} illustra graficamente il caso d’uso UC2.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_2.jpg}
        \caption{UC2}
        \label{fig:uc2}
    \end{figure}
\end{minipage}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc2_sottocasi} illustra graficamente i sottocasi del caso d'uso UC2.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{usecase/uc_2_sottocasi.jpg}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc3} illustra graficamente il caso d'uso UC3.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_3.jpg}
        \caption{UC3}
        \label{fig:uc3}
    \end{figure}
\end{minipage}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc4} illustra graficamente il caso d'uso UC4.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{usecase/uc_4.jpg}
        \caption{UC4}
        \label{fig:uc4}
    \end{figure}
\end{minipage}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc5} illustra graficamente il caso d'uso UC5.
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{usecase/uc_5.jpg}
        \caption{UC5}
        \label{fig:uc5}
    \end{figure}
\end{minipage}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc7} illustra graficamente il caso d’uso UC7.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_7.jpg}
        \caption{UC7}
        \label{fig:uc7}
    \end{figure}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{usecase/uc_8.jpg} 
        \caption{UC8}
        \label{fig:uc8}
    \end{figure}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_9.jpg}
        \caption{UC9}
        \label{fig:uc9}
    \end{figure}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_10.jpg}
        \caption{UC10}
        \label{fig:uc10}
    \end{figure}
\end{minipage}
...
\begin{usecase}{11}{Visualizzazione della frequenza di una parola chiave}\label{UC11}
    ...
    \usecaseextEnv{\begin{itemize}
        \item \hyperref[UC21]{UC21}: Visualizzazione di un avviso se la frequenza di una parola chiave è 0.
    \end{itemize}}
\end{usecase}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc11} illustra graficamente il caso d'uso UC11.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{usecase/uc_11.jpg}
        \caption{UC11}
        \label{fig:uc11}
    \end{figure}
\end{minipage}
...
\begin{usecase}{12}{Visualizzazione della densità di una parola chiave}\label{UC12}
    ...
    \usecaseextEnv{\begin{itemize}
        \item \hyperref[UC22]{UC22}: Visualizzazione di un avviso se la densità di una parola chiave è 0\%.
    \end{itemize}}
\end{usecase}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{usecase/uc_12.jpg}
        \caption{UC12}
        \label{fig:uc12}
    \end{figure}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_13.jpg}
        \caption{UC13}
        \label{fig:uc13}
    \end{figure}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_13_sottocasi.jpg}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_13_1_sottocasi.jpg}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{usecase/uc_14.jpg}
    \caption{UC14}
    \label{fig:uc14}
    \end{figure}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_15.jpg}
        \caption{UC15}
        \label{fig:uc15}
    \end{figure}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_16.jpg}
        \caption{UC16}
        \label{fig:uc16}
    \end{figure}
\end{minipage}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc17} illustra graficamente il caso d'uso UC17.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_17.jpg}
        \caption{UC17}
        \label{fig:uc17}
    \end{figure}
\end{minipage}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc18} illustra graficamente il caso d'uso UC18.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{usecase/uc_18.jpg}
        \caption{UC18}
        \label{fig:uc18}
    \end{figure}
\end{minipage}
...
\par\noindent
\begin{minipage}{\textwidth}
    La figura \ref{fig:uc23} illustra graficamente il caso d'uso UC23.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{usecase/uc_23.jpg}
        \caption{UC23}
        \label{fig:uc23}
    \end{figure}
\end{minipage}
