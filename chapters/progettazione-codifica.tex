...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{getParentName}: restituisce il nome dell’elemento genitore più vicino, risalendo la gerarchia con approccio bottom-up, tra quelli considerati rilevanti per l’analisi;
