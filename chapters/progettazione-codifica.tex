...
\begin{itemize}
  \item \textbf{KeywordAnalysisStrategy}: simula un’interfaccia all’interno del pattern Strategy, definendo il contratto che le classi concrete devono implementare.
\end{itemize}
